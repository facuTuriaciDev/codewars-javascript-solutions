/*
An array is given with palindromic and non-palindromic numbers. A palindromic number is a number that is the same from a reversed order. 
...
const convertPalindromes = numbers => numbers.map((e) => {
  return e.toString() === e.toString().split('').reverse().join('') ? 1 : 0;
});